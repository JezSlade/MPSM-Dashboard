...
<header class="app-header relative flex items-center justify-end space-x-4 px-6 py-4 bg-gray-800 bg-opacity-75 backdrop-blur-md shadow-lg">
  ...
  <div class="relative z-10 flex items-center space-x-4">
    ...
    <button id="theme-toggle" class="p-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-400" title="Toggle Light/Dark">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-cyan-400" fill="currentColor" viewBox="0 0 20 20">
    ...
    <!-- Open Debug Log (Bug icon, Magenta) -->
    ...
    <!-- Clear Session Cookies (Cookie icon, Yellow) -->
    ...
    <!-- Hard Refresh (Refresh icon, Black) -->
