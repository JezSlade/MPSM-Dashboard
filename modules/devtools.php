...
<div class="space-y-6">
    ...
    <div class="glass p-4 border border-gray-800 rounded">
        ...
        <form method="POST" class="mt-4 space-y-4">
            ...
            <button type="submit" name="clear_cache" class="mt-2 bg-black-smoke text-magenta-neon p-2 rounded border border-gray-700 hover:bg-gray-700">🗑️ Clear Cache</button>
        </form>
    </div>
