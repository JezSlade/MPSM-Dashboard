...
2. **SQL Files**: Backup and direct execution options
   - [insert-alert-rules.sql](insert-alert-rules.sql) - Pure SQL
...
- **Test scripts**: [test-pattern-matching.php](test-pattern-matching.php), [test-pattern-fix.php](test-pattern-fix.php)
