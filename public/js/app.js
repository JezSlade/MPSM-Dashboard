 ...
 * public/js/app.js
 * ------------------------------------------------------
 * Groups endpoints by role, renders a fancy dropdown,
 * displays cards, powers Try-It via proxy, and logs all
 * into a toggleable, clearable Debug Panel; modal close
 * by X, backdrop, or Escape.
 * ------------------------------------------------------
 */
(function(){
  'use strict';
