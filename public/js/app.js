 ...
 * public/js/app.js
 * ------------------------------------------------------
 * Groups endpoints by role, renders a styled selector,
 * displays cards, powers Try-It proxy, and logs all
 * into the enhanced Debug Panel (toggleable & clearable).
