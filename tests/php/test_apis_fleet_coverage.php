 ...
 *
 * Usage: php tests/php/test_apis_fleet_coverage.php
 */
...
// Build test URLs
$baseUrl = getenv('MPSM_TEST_BASE_URL') ?: 'http://localhost:8000/cms/api';
$testApis = [
    [
...
file_put_contents(dirname(__DIR__) . '/reports/test_apis_fleet_coverage_report.json', $reportJson);

echo "\nJSON Report saved to: tests/reports/test_apis_fleet_coverage_report.json\n";

if ($warnCount > 0 || $failCount > 0 || $errorCount > 0) {
    exit(1);
}
