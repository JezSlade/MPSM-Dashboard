...
------------ | ------------- | ------------- | -------------
**ticket_id** | **string** | Ticket Id | [optional]
...
**is_parked** | **bool** | Gets or sets a value indicating whether is parked | [optional]
**is_flagged** | **bool** | Gets or sets a value indicating whether is flagged | [optional]
