...
------------ | ------------- | ------------- | -------------
**product_model** | **string[]** | Gets or sets the product model. | [optional]
**filter_dealer_code** | **string** | Gets or sets the filter dealer code. | [optional]
**filter_customer_code** | **string** | Filter by a string contained in CustomerCode or CustomerDescription | [optional]
