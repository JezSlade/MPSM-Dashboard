...
------------ | ------------- | ------------- | -------------
**language** | **string** | Defines the default language of the account | [optional]
...
**force2fa** | **bool** | Gets or sets a value indicating whether this {MpsMonitor.Models.Contracts.Account.CreateAccountRequest} must use 2fa. | [optional]
...
**send_activation_email** | **bool** | Defines if send the activation email to the new user | [optional]
