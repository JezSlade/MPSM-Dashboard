# # ListResultResponseCustomerPrintReleafTransactionRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**result** | [**\OpenAPI\Client\Model\CustomerPrintReleafTransactionRequest[]**](CustomerPrintReleafTransactionRequest.md) | Gets or sets the result. | [optional]
