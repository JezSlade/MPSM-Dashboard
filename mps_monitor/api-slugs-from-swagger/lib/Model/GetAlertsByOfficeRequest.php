...
/**
 * GetAlertsByOfficeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetAlertsByOfficeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAlertsByOfficeRequest';
    ...
    */
     ...
     * Sets office_id
     *
     * @param string $office_id Gets or sets the office identifier.
     *
     * @return self
     */
     ...
     * Sets level
     *
     * @param int|null $level Gets or sets the level.
     *
     * @return self
     */
