...
/**
 * UploadUniversalPrintAgentLogsRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class UploadUniversalPrintAgentLogsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadUniversalPrintAgentLogsRequest';
    ...
    */
     ...
     * Sets customer_code
     *
     * @param string|null $customer_code The customer code
     *
     * @return self
     */
     ...
     * Sets agent_id
     *
     * @param string|null $agent_id The customer code
     *
     * @return self
     */
