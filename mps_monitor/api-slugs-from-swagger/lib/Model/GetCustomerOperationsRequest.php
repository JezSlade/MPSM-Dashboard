...
/**
 * GetCustomerOperationsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetCustomerOperationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCustomerOperationsRequest';
    ...
    public const OPERATION_TYPE_ALL = 'All';
    public const OPERATION_TYPE_SHOW_WPP_ONLY = 'ShowWppOnly';
    public const OPERATION_TYPE_SHOW_NON_WPP_ONLY = 'ShowNonWppOnly';
    public const OPERATION_STATUS_ALL = 'All';
    public const OPERATION_STATUS_ONLY_SUCCESS = 'OnlySuccess';
    public const OPERATION_STATUS_ONLY_PENDING = 'OnlyPending';
    public const OPERATION_STATUS_ONLY_ERRORS = 'OnlyErrors';
    ...
    {
        return [
            self::OPERATION_TYPE_ALL,
            self::OPERATION_TYPE_SHOW_WPP_ONLY,
            self::OPERATION_TYPE_SHOW_NON_WPP_ONLY,
        ];
    }
    ...
    public function getOperationStatusAllowableValues()
    {
        return [
            ...
            self::OPERATION_STATUS_ONLY_SUCCESS,
            self::OPERATION_STATUS_ONLY_PENDING,
            self::OPERATION_STATUS_ONLY_ERRORS,
        ];
    }
    ...
    */
     ...
     *
     * @param string|null $operation_status operation_status
     *
     * @return self
     */
