...
/**
 * UpdateCustomerInvoiceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateCustomerInvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateCustomerInvoiceRequest';
    ...
    */
     ...
     *
     * @param string $external_identifier Gets or sets ExternalIdentifier              The ExternalIdentifier to update.              Pass a valid value or an empty string to clear the ExternalIdentifier.
     *
     * @return self
     */
