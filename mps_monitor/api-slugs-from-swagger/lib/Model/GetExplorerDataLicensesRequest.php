...
/**
 * GetExplorerDataLicensesRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class GetExplorerDataLicensesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetExplorerDataLicensesRequest';
    ...
    */
     ...
     * Sets customer_code
     *
     * @param string $customer_code Defines the customer code.
     *
     * @return self
     */
