...
/**
 * OnboardingQuestionDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OnboardingQuestionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnboardingQuestionDto';
    ...
    protected static $openAPITypes = [
        ...
        'answer_type' => 'string',
        'orientation' => 'string',
        'allowed_values' => '\OpenAPI\Client\Model\KeyValue[]',
        'visibility_rule' => '\OpenAPI\Client\Model\OnboardingVisibilityRuleDto',
        'value' => 'string'
    ];
    ...
    public const ANSWER_TYPE_TEXT = 'Text';
    public const ANSWER_TYPE_NUMBER = 'Number';
    public const ANSWER_TYPE_SINGLE = 'Single';
    public const ANSWER_TYPE_MULTI = 'Multi';
    public const ANSWER_TYPE_BOOLEAN = 'Boolean';
    ...
    public function getAnswerTypeAllowableValues()
    {
        return [
            ...
            self::ANSWER_TYPE_SINGLE,
            self::ANSWER_TYPE_MULTI,
            self::ANSWER_TYPE_BOOLEAN,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('visibility_rule', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['answer_type']) && !in_array($this->container['answer_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'answer_type', must be one of '%s'",
                $this->container['answer_type'],
     ...
     * Sets answer_type
     *
     * @param string|null $answer_type answer_type
     *
     * @return self
     */
    public function setAnswerType($answer_type)
    {
        if (is_null($answer_type)) {
            throw new \InvalidArgumentException('non-nullable answer_type cannot be null');
        }
        $allowedValues = $this->getAnswerTypeAllowableValues();
        if (!in_array($answer_type, $allowedValues, true)) {
     ...
     * Sets allowed_values
     *
     * @param \OpenAPI\Client\Model\KeyValue[]|null $allowed_values allowed_values
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\OnboardingVisibilityRuleDto|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OnboardingVisibilityRuleDto|null $visibility_rule visibility_rule
     *
     * @return self
     */
    public function setVisibilityRule($visibility_rule)
    {
        if (is_null($visibility_rule)) {
            throw new \InvalidArgumentException('non-nullable visibility_rule cannot be null');
        }
