...
/**
 * GetExplorerDataCommandsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetExplorerDataCommandsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetExplorerDataCommandsRequest';
    ...
    */
     ...
     * Sets customer_code
     *
     * @param string $customer_code Gets or sets the CustomerCode.
     *
     * @return self
     */
