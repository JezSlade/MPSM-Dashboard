...
/**
 * FreeSearchRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FreeSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreeSearchRequest';
    ...
    public const RESULT_TYPE_DEALER = 'Dealer';
    public const RESULT_TYPE_CUSTOMER = 'Customer';
    public const RESULT_TYPE_DEVICE = 'Device';
    public const RESULT_TYPE_TICKET = 'Ticket';
    ...
    {
        return [
            self::RESULT_TYPE_DEALER,
            self::RESULT_TYPE_CUSTOMER,
            self::RESULT_TYPE_DEVICE,
            self::RESULT_TYPE_TICKET,
        ];
    }
    ...
    */
     ...
     * Sets result_type
     *
     * @param string|null $result_type Gets or sets the type of the result.
     *
     * @return self
     */
    public function setResultType($result_type)
    {
        ...
        $allowedValues = $this->getResultTypeAllowableValues();
        if (!in_array($result_type, $allowedValues, true)) {
     ...
     * Sets dealer_id
     *
     * @param string|null $dealer_id Set the dealerId
     *
     * @return self
     */
