 ...
 */
class DocItemDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocItemDto';
    ...
    protected static $openAPITypes = [
        ...
        'link' => 'string',
        'thumbnail' => 'string',
        'file' => '\OpenAPI\Client\Model\FileInfoDto',
        'creation' => '\DateTime',
        'id' => 'string'
    ];
    ...
    */
     ...
     * Sets file
     *
     * @param \OpenAPI\Client\Model\FileInfoDto|null $file file
     *
     * @return self
     */
