...
/**
 * BusinessCreditDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCreditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCreditDto';
    ...
    {
        $this->setIfExists('vat_no', $data ?? [], null);
        $this->setIfExists('reg_no', $data ?? [], null);
        $this->setIfExists('safe_no', $data ?? [], null);
    ...
    */
     ...
     * Sets vat_no
     *
     * @param string[]|null $vat_no vat_no
     *
     * @return self
     */
    ...
    {
        if (is_null($vat_no)) {
            throw new \InvalidArgumentException('non-nullable vat_no cannot be null');
        }
     ...
     * Sets reg_no
     *
     * @param string|null $reg_no reg_no
     *
     * @return self
     */
     ...
     * Sets safe_no
     *
     * @param string|null $safe_no safe_no
     *
     * @return self
     */
    ...
    {
        if (is_null($safe_no)) {
            throw new \InvalidArgumentException('non-nullable safe_no cannot be null');
        }
