...
/**
 * NotificationModeWebCallbackDto Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class NotificationModeWebCallbackDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationModeWebCallbackDto';
    ...
    */
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint Gets or sets the endpoint.
     *
     * @return self
     */
     ...
     *
     * @param string|null $authentication_value authentication_value
     *
     * @return self
     */
