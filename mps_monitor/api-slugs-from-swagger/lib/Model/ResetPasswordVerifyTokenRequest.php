...
/**
 * ResetPasswordVerifyTokenRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ResetPasswordVerifyTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResetPasswordVerifyTokenRequest';
    ...
    */
     ...
     * Sets token
     *
     * @param string $token Gets or sets the  token.
     *
     * @return self
     */
     ...
     *
     * @param string $confirm_password Gets or sets the confirm password.
     *
     * @return self
     */
