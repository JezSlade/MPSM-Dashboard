...
/**
 * PowerBiReportDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PowerBiReportDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerBiReportDto';
    ...
    */
     ...
     * Sets embed_url
     *
     * @param string|null $embed_url Gets or sets the embed URL.
     *
     * @return self
     */
     ...
     * Sets access_level
     *
     * @param string|null $access_level Gets or sets the access level.
     *
     * @return self
     */
