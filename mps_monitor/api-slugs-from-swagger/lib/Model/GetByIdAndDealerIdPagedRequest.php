...
/**
 * GetByIdAndDealerIdPagedRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetByIdAndDealerIdPagedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetByIdAndDealerIdPagedRequest';
    ...
    */
     ...
     * Sets dealer_id
     *
     * @param string $dealer_id Gets or sets the dealer identifier.
     *
     * @return self
     */
