...
/**
 * GetTicketAttachmentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTicketAttachmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTicketAttachmentRequest';
    ...
    */
     ...
     *
     * @param string|null $attachment_name Gets or sets the name of the attachment.
     *
     * @return self
     */
