...
/**
 * GetByIdAndDeviceIdPagedRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetByIdAndDeviceIdPagedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetByIdAndDeviceIdPagedRequest';
    ...
    */
     ...
     * Sets device_id
     *
     * @param string $device_id Gets or sets the device identifier.
     *
     * @return self
     */
