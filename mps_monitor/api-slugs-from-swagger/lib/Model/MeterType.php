 ...
 */
class MeterType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeterType';
    ...
    */
     ...
     * Sets thirdparty
     *
     * @param string|null $thirdparty thirdparty
     *
     * @return self
     */
    public function setThirdparty($thirdparty)
    {
        if (is_null($thirdparty)) {
            throw new \InvalidArgumentException('non-nullable thirdparty cannot be null');
        }
