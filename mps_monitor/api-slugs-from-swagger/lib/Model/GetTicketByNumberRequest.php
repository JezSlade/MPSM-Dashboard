...
/**
 * GetTicketByNumberRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTicketByNumberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTicketByNumberRequest';
    ...
    */
     ...
     * Sets ticket_number
     *
     * @param int|null $ticket_number Gets or sets the ticket number.
     *
     * @return self
     */
