...
/**
 * OfficeFloorDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OfficeFloorDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfficeFloorDto';
    ...
    protected static $openAPITypes = [
        ...
        'devices' => '\OpenAPI\Client\Model\OfficeFloorDeviceDto[]',
        'id' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('image_base64_content', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $image_base64_content image_base64_content
     *
     * @return self
     */
    public function setImageBase64Content($image_base64_content)
    {
        if (is_null($image_base64_content)) {
            throw new \InvalidArgumentException('non-nullable image_base64_content cannot be null');
        }
     ...
     * Gets devices
     *
     * @return \OpenAPI\Client\Model\OfficeFloorDeviceDto[]|null
     */
     ...
     * Sets devices
     *
     * @param \OpenAPI\Client\Model\OfficeFloorDeviceDto[]|null $devices devices
     *
     * @return self
     */
