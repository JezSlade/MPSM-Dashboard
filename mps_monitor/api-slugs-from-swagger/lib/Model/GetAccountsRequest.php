...
/**
 * GetAccountsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetAccountsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAccountsRequest';
    ...
    public const ORIGIN_TYPE_MPS = 'Mps';
    public const ORIGIN_TYPE_API = 'Api';
    ...
    {
        return [
            self::ORIGIN_TYPE_MPS,
            self::ORIGIN_TYPE_API,
        ];
    }
    ...
    */
     ...
     * Sets roles
     *
     * @param string[]|null $roles Gets or sets the roles.
     *
     * @return self
     */
     ...
     * Sets dealer_code
     *
     * @param string|null $dealer_code Results filter by dealer code
     *
     * @return self
     */
     ...
     * Sets customer_code
     *
     * @param string|null $customer_code Results filtered by customer code
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Gets or sets the is active.
     *
     * @return self
     */
