...
> Historical session note. Verify any deployment commands or operational assumptions against `context/current-state.md` and `docs/operations/DEPLOY-INSTRUCTIONS.md` before using them.
