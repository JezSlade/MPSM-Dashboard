<?php
// core/mps_api.php
// v1.0.1 [More robust token & curl handling]

require_once __DIR__ . '/config.php';
require_once __DIR__ . '/debug.php';

/**
 * Get or refresh a cached MPS Monitor token.
 */
function get_mps_token(): string {
    ...
    $resp = curl_exec($ch);
    if (curl_errno($ch)) {
        debug_log('Curl error get_mps_token', ['err' => curl_error($ch)], 'ERROR');
        curl_close($ch);
...
/**
 * Fetch data from MPS Monitor API using valid bearer token.
 */
